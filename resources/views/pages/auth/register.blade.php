            ...
            <form method="POST" action="{{route('register')}}">
                @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input id="roles" type="text" class="form-control @error('roles')
                        is-invalid
                        @enderror" name="roles" autofocus>
                    </div>
                    @error('roles')
                        <div class="invalid-feedback">
                            {{$message}}
                    ...
                    </div><div class="text-muted mt-5 text-center">
                        Already account? <a href="{{route('login')}}">Log In</a>
                    </div>
            </form>
        </div>
    </div>
